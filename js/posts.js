...
/* 글 목록: 최신 글이 배열 맨 위 */
var POSTS = [
  { id: "zodiac-year-age", title: "십이지 띠로 나이·출생연도 찾기 — 내 띠, N띠는 몇년생·몇 살?", summary: "열두 띠별 출생연도와 2026년 나이를 표로 한눈에. 띠로 나이를 가늠할 때 헷갈리는 점까지 정리했습니다.", category: "birthyear", date: "2026.08.13", url: "/posts/zodiac-year-age.html", image: "/img/zodiac-year-age.svg" },
  ...
  { id: "senior-benefits-age", title: "지하철 무임승차·경로우대 나이 총정리 (만 65세 혜택)", summary: "지하철 무임·기초연금 만 65세 혜택. 자동 vs 신청 + 무임 연령 70세 상향 논의까지.", category: "system", date: "2026.07.24", url: "/posts/senior-benefits-age.html", image: "/img/senior-benefits-age.svg" },
  { id: "pension-start-age", title: "국민연금 수급 개시 나이 — 출생연도별 노령연금 받는 나이 (2026)", summary: "출생연도별 62~65세부터. 실제 얼마 받나(왜 짠지)·기초연금 구분·조기/연기수급까지.", category: "system", date: "2026.07.23", url: "/posts/pension-start-age.html", image: "/img/pension-start-age.svg" },
  { id: "birthyear-to-hakbeon", title: "몇년생 몇 학번? 출생연도–학번 환산표 (재수·빠른년생 포함)", summary: "출생연도 + 19 = 학번. 재수·빠른년생·같은 학번 나이차 + 입사동기·후배 족보 꼬임까지.", category: "birthyear", date: "2026.07.22", url: "/posts/birthyear-to-hakbeon.html", image: "/img/birthyear-to-hakbeon.svg" },
  { id: "fast-year-birth", title: "빠른 년생이란? 빠른 05·06년생 학년·나이 완전정리", summary: "빠른 년생은 나이가 아니라 학년만 앞선다. 요즘 사회에선 어떻게 대하나(년도로 끊기·합의)까지.", category: "birthyear", date: "2026.07.21", url: "/posts/fast-year-birth.html", image: "/img/fast-year-birth.svg" },
  { id: "age-types-korean", title: "만 나이 vs 세는 나이 vs 연 나이 차이 (2023 개정 후 완전정리)", summary: "세 나이 차이와 '같은 년생 형·친구?', '몇년생으로 답하기', 통일 오해(연금·정년)까지.", category: "age", date: "2026.07.20", url: "/posts/age-types-korean.html", image: "/img/age-types-korean.svg" },
