/*
 * 도깨비 사주/궁합 수익화 인터랙션
 *  1) '이어서 도깨비의 풀이 보기' 클릭 → 쿠팡(새 탭) + 3초 뒤 가려진 풀이 자동 공개
 *  2) '무료 궁합/궁합 보기' 링크 클릭 → 쿠팡(새 탭) + 3초 뒤 궁합 사이트로 자동 이동
 * (상단 내비게이션 링크는 제외)
 */
(function () {
  "use strict";
  ...
  // 1) 이어서 풀이 보기 → 쿠팡 새 탭(앵커 기본 동작) + 3초 뒤 블러 해제
  ...
  // 2) 궁합 링크(콘텐츠 내) → 쿠팡 새 탭 + 3초 뒤 /gunghap/ 이동
  document.addEventListener("click", function (e) {
    ...
    setTimeout(function () { window.location.href = "/gunghap/"; }, DELAY);
  }, false);
})();
