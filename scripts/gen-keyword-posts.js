...
'    <div class="footer-brand"><span class="footer-logo">🗓️</span><span class="footer-brandname">한국인계산기</span></div>\n' +
'    <nav class="footer-links"><a href="/">홈</a> · <a href="/about/">운영자 소개</a> · <a href="/contact/">문의하기</a> · <a href="/guide/">사이트 안내</a> · <a href="/privacy/">개인정보처리방침</a> · <a href="/terms/">이용약관</a> · <a href="mailto:leehyosone180603@gmail.com">이메일</a></nav>\n' +
...
'    <p class="footer-copy">© <span id="year"></span> 한국인계산기 (calcbox.kr) · 본 글은 일반적인 정보 제공을 목적으로 하며 최신 정보는 공식 출처를 확인하세요.</p>\n' +
'  </footer>\n' +
'\n' +
'  <script>\n' +
